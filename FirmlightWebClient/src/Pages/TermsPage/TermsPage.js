...
const TermsPage = () => {
    const sections = [
        {
            title: "Introduction",
            content: `These Terms and Conditions ("Terms") govern your use of the Firmlight website ("Website").
        ...
        {
            title: "Privacy",
            content: "Your use of the Website is also governed by our Privacy Policy, which can be found at " + firmlightAddress + "/privacy" + ". By using the Website, you consent to the practices described in the Privacy Policy.",
        },
        {
        ...
        },
        {
            ...
            subPoints: [
                ...
                "We do not warrant that the Website will be ErrorPage-free, uninterrupted, secure, or free from viruses or other harmful components.",
            ],
        },
        {
