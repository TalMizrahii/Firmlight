...
const PrivacyPage = () => {
    ...
    const sections = [
        {
            title: "Introduction",
            content: "At Firmlight, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal information. By using our website, you consent to the practices described in this policy.",
            subPoints: [],
        },
        {
